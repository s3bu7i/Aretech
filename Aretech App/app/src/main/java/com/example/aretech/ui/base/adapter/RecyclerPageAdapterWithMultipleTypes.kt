...
class RecyclerPageAdapterWithMultipleTypes<VBL: ViewBinding,VBG: ViewBinding,D : Any> @JvmOverloads constructor(
...
) : PagingDataAdapter<D, RecyclerView.ViewHolder>(diffCallback) {
